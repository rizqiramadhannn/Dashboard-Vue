<template>
    <div class="container">
        ...
        <form @submit.prevent="submitForm">
            ...
            <input type="text" id="alamat-supplier" placeholder="Masukan Alamat Supplier" v-model="hargaSupplier" required>
            </div>
            <div class="form-group">
            <label for="notelp-supplier">No telp supplier</label>
            <input type="text" id="notelp-supplier" placeholder="Masukan No Telp Supplier" v-model="stokSupplier" required>
            </div>
  ...
  export default {
    ...
    methods: {
      submitForm() {
        ...
        // You can access the form data through the component's data properties (e.g., this.namaSupplier, this.hargaSupplier, etc.)
